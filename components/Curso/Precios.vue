<template>
 <div class="p-4 xl:w-3/5 md:w-3/4 w-full mx-auto group">
        <div class="h-auto p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden group-hover:border-orange-500/60 transition">
          ...
          <div class="mt-16">
            <button v-if="stock >= 1 && carga == false && Precio !='000'" class=" hidden items-center md:mt-auto my-2 text-white bg-gray-400 border-0 py-2 px-4 w-full focus:outline-none hover:bg-gray-500 rounded group-hover:scale-105 group-hover:bg-orange-500 transition font-texto" @click="initCheckout">
            Inscribirme ahora
