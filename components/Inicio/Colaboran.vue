...
<section class="container mx-auto mb-20">
    <div class="py-8 lg:py-16 mx-auto max-w-screen-xl px-4">
        <h4 class="mb-8 lg:mb-16 text-3xl tracking-tight leading-tight text-center text-gray-600 md:text-4xl font-titulo opacity-90">Colaboradores<span class="text-orange-500"> | </span>Partners</h4>
